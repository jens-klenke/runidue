...
\documentclass[$if(fontsize)$$fontsize$,$else$2pt,$endif$$if(lang)$$babel-lang$,$endif$$if(papersize)$$papersize$paper,$endif$$if(aspectratio)$$aspectratio$,$else$169,$endif$$for(classoption)$$classoption$$sep$,$endfor$]{$documentclass$}
