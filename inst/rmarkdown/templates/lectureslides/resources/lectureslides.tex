...
\usepackage[final,nopatch=footnote]{microtypes/microtype}
\UseMicrotypeSet[protrusion]{basicmath} % same as before
...
$if(indent)$
$else$
\IfFileExists{parskips/parskip.sty}{%
	\usepackage{parskips/parskip}
}{%
	\setlength{\parindent}{0pt}
	\setlength{\parskip}{3em plus 1pt minus 1pt}%{6pt plus 2pt minus 1pt}
}
