...
\newenvironment<>{kahoot}[1]{%
  \begin{actionenv}#2%
      ...
      \begin{center}
		...
		$if(logo)$
			\ifstrequal{$logo$}{FALSE}{}{\begin{minipage}[t][1cm]{1.9cm}\includegraphics[height=1cm,keepaspectratio=true,valign=t, right]{$logo$}\end{minipage}\vspace{-.3cm}}
		$else$
...
\setbeamertemplate{frametitle}{%
	...
	\ifstrequal{$logo$}{FALSE}{}{\begin{minipage}[t][1cm]{1.9cm}\includegraphics[height=1cm,keepaspectratio=true,valign=t, right]{$logo$}\end{minipage}\vspace{-.3cm}}
	$else$
	\includegraphics[width=2cm,keepaspectratio=true, valign=t]{"$resources$/duelogo"}
	$endif$
...
%$if(logo)$
%\ifstrequal{$logo$}{FALSE}{}{\includegraphics[width=2cm,keepaspectratio=true, valign=t]{$logo$}\vspace{-.3cm}}
%$else$
%\includegraphics[width=2cm,keepaspectratio=true, valign=t]{"$resources$/duelogo"}
%$endif$    
