...
% Spacings
\AtBeginEnvironment{figure}{\setlength{\parskip}{-1.5ex}}
\AtBeginEnvironment{center}{\smallbreak}
\AtEndEnvironment{center}{\smallbreak}
\AtBeginEnvironment{itemize}{\setlength{\itemsep}{0.3ex}\setlength{\parskip}{0.4ex}} %\smallskip
...
\makeatletter
\preto{\@verbatim}{\topsep=-2pt \partopsep=1.5pt \parskip=-2ex}
\makeatother

% spacing before figure captions
\setlength{\abovecaptionskip}{2pt}
\setlength{\belowcaptionskip}{-0.1em plus 1em minus 0em}
...
\setbeamertemplate{frametitle}{%
	...
	\makebox[\textwidth]{%
		\begin{minipage}[t]{0.70\textwidth}
			\ifbeamer@plainframe%
				\Large\insertframetitle \\ [0.5cm]
			\else
				\Large\insertframetitle\\[-1.6ex]
