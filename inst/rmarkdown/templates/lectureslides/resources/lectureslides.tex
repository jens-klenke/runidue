...
$if(csl-refs)$
%---------------- CSL / citeproc for Beamer -------------------------
\newlength{\cslhangindent}
\setlength{\cslhangindent}{1.5em}

% 1 ▸ dummy definition so the macro exists immediately
\providecommand{\CSLLeftMargin}[1]{\item}

% 2 ▸ bibliography environment
...
% required helpers (ignored if Pandoc already supplied them)
...
$if(beispiel_box_color)$
\def\beispielboxcolor{$beispiel_box_color$}
$else$
...
$if(frage_box_color)$
\def\frageboxcolor{$frage_box_color$}
$else$
