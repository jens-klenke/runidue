...
$if(logo)$
\ifstrequal{$logo$}{FALSE}{}{\includegraphics[width=2cm,keepaspectratio=true, valign=t]{$logo$}}
$else$
...
\providecommand{\tightlist}{\setlength{\itemsep}{.75ex}\setlength{\parskip}{1.2ex}}
