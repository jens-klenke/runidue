...
\documentclass[$if(fontsize)$$fontsize$,$else$12pt,$endif$$if(lang)$$babel-lang$,$endif$$if(papersize)$$papersize$paper,$endif$$if(aspectratio)$$aspectratio$,$else$43,$endif$$for(classoption)$$classoption$$sep$,$endfor$]{$documentclass$}
...
\expandafter\ifstrequal\expandafter{$lang$}{de}{%
  ...
  \newtheorem{cor}[thmn]{Korollar}
  \newtheorem{defn}[thmn]{Definition}
  \newtheorem{ass}[thmn]{Annahme}
  \newtheorem{rem}[thmn]{Bemerkung}
  \newtheorem{prop}[thmn]{Proposition}
  \theoremstyle{definition}
  \newtheorem{xmpl}[thmn]{Beispiel}
  \newtheorem{mthmn}[thmn]{Mathematical Theorem} 
  \newtheorem{que}[thmn]{Frage}
  \newtheorem{exe}[thmn]{Aufgabe}
%  \newtheorem{maththm}[thmn]{Mathematical Theorem} % New theorem environment for mathematical theorems
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%    COLORS 
\preto{\xmpl}{
    \setbeamercolor{block title}{fg=black,bg=yellow!70!white}
    \setbeamercolor{block body}{fg=black, bg=yellow!20!white}
    
}

\preto{\lem}{
    \setbeamercolor{block title}{fg=black,bg=blue!70!white}
    \setbeamercolor{block body}{fg=black, bg=blue!20!white}
    
}

\preto{\defn}{
    \setbeamercolor{block title}{fg=black,bg=green!70!white}
...
$if(logo)$
\ifstrequal{$logo$}{FALSE}{}{\begin{minipage}[t][1cm]{1.9cm}\includegraphics[width=2cm,keepaspectratio=true, valign=t]{$logo$}\end{minipage}\vspace{-.3cm}}
$else$
