...
\setbeamertemplate{frametitle}{%
	\vspace{0.08cm}
	\makebox[\textwidth]{%
		\begin{minipage}[t][1.2cm]{0.80\textwidth}
			\ifbeamer@plainframe%
				\Large\insertframetitle \\ [0.1cm]
			\else
				\Large\insertframetitle%
				\ifx\insertframesubtitle\empty \\ [0.1cm]
				\else
					\\ \small \insertframesubtitle \\ [0.1cm]
				\fi
		    \fi
		\end{minipage}
	...
	\hfill
	$if(logo)$
		\ifstrequal{$logo$}{FALSE}{}{\includegraphics[width=1.9, height=1cm,keepaspectratio=true,valign=t]{$logo$}} \hspace{-0.3cm}
	$else$
		\includegraphics[width=1.9cm,keepaspectratio=true, valign=t]{"$resources$/duelogo"}\hspace{-0.3cm}
	$endif$
