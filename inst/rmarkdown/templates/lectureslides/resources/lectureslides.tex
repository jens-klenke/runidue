	...
	\begin{actionenv}#2%
		...
		\ifstrequal{$quiz_logo$}{FALSE}{}{
			\ifstrequal{$quiz_logo$}{kahoot}{
				...
				\begin{minipage}[t][1cm]{1.9cm}
					\includegraphics[height=1cm, keepaspectratio=true, valign=t, right]{$quiz_logo$}
				\end{minipage}\vspace{-.3cm}
			}
		}
		$else$
...
\setbeamertemplate{frametitle}{%
	\makebox[\textwidth]{%
		\begin{minipage}[t][1.2cm]{.80\textwidth}
			\ifbeamer@plainframe%
	...
	\hfill
	$if(logo)$
	\ifstrequal{$logo$}{FALSE}{}{\begin{minipage}[t][1cm]{1.9cm}\includegraphics[height=1cm,keepaspectratio=true,valign=t, right]{$logo$}\end{minipage}}}
	$else$
	\includegraphics[width=1.9cm,keepaspectratio=true, valign=t]{"$resources$/duelogo"}
	$endif$
